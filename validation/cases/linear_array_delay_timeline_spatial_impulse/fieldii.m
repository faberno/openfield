case_name = 'linear_array_delay_timeline_spatial_impulse';
...
aperture = xdc_linear_array(elements, width, height, kerf, sub_x, sub_y, [0 0 40e-3]);
xdc_focus_times(aperture, 0, delays);
